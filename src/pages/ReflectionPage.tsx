...
const teamMembers: TeamMember[] = [
    {
        ...
        reflection: [
            "As the team lead and website developer for this project, my primary responsibility was designing and implementing the interactive learning platform using React. The website was intentionally designed as an active learning environment rather than a static showcase, allowing users to explore how different path planning algorithms behave and make decisions. This required careful consideration of both the technical architecture and the educational flow presented to users.",
            "The most challenging aspect of the project was developing the interactive simulations. Unlike videos or static explanations, interactive systems must respond correctly to all user actions. Features such as placing obstacles, selecting start and goal positions, switching algorithms, and stepping through execution needed to accurately reflect the underlying logic of each algorithm. This complexity increased because the platform includes multiple categories of path planning approaches, including reactive methods, grid-based algorithms such as A*, and sampling-based techniques, each requiring different assumptions and visual feedback.",
            "A key design challenge was ensuring that the interface remained accessible to beginners while maintaining technical accuracy. For example, grid-based algorithms perform systematic node exploration, while reactive algorithms respond only to local information and may become trapped in loops. Communicating these differences visually without overwhelming users required multiple iterations of interface design. The inclusion of controls such as “Run”, “Step”, and “Reset” was intentional, allowing users to slow down execution and observe algorithmic decision-making incrementally.",
            "Another important design decision was structuring the interactive page into clear conceptual stages. Users first select how the robot plans its movement before choosing a specific algorithm. This structure helps learners understand that individual algorithms belong to broader categories, rather than viewing them as isolated techniques. Supporting explanation panels and mini challenges were added to encourage users to reflect and predict outcomes before observing results.",
            "Through developing the website, I gained a deeper understanding of both path planning algorithms and educational design principles. I learned that even simple algorithms can become confusing if visualized poorly, and that small interface choices significantly influence user understanding. As a team lead, I also coordinated technical direction, integrated feedback from teammates, and ensured consistency across the platform. Balancing leadership and development responsibilities was demanding, but it strengthened my communication, decision-making, and user-centered design skills, reinforcing the importance of collaboration and iterative refinement in educational robotics projects."
        ]
    },
    {
